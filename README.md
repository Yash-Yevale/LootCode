...
We were fed up with the normal solutions to studying DSA for technical interviews and decided to make something a lot more fun. At first, we looked at the most mainstream solutions such as Hackerrank and Leetcode, but those too were boring. 

Starting from the ground up, we constructed a game-play loop consisting of solving problems to earn gold, spending gold for items to beat enemies, and unlocking lore to progress the story. With over 35+ enemy encounters and 75+ problems, there is a LOT of game-play to be enjoyed with Lootcode.
